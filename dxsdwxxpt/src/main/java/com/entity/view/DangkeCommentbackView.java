...
public class DangkeCommentbackView extends DangkeCommentbackEntity implements Serializable {
	...
	public DangkeCommentbackView() {

	}

	public DangkeCommentbackView(DangkeCommentbackEntity dangkeCommentbackEntity) {
		try {
			BeanUtils.copyProperties(this, dangkeCommentbackEntity);

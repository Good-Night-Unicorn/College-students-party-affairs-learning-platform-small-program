...
public class XuexiCollectionView extends XuexiCollectionEntity implements Serializable {
	...
	*/
	...
	private String xuexiCollectionValue;
	...
	public XuexiCollectionView() {

	}

	public XuexiCollectionView(XuexiCollectionEntity xuexiCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, xuexiCollectionEntity);
	...
	* 获取： 类型的值
	*/
	public String getXuexiCollectionValue() {
		return xuexiCollectionValue;
	}
	/**
	* 设置： 类型的值
	*/
	public void setXuexiCollectionValue(String xuexiCollectionValue) {
		this.xuexiCollectionValue = xuexiCollectionValue;
	}
	...
	public String toString() {
		return "XuexiCollectionView{" +
			", xuexiCollectionValue=" + xuexiCollectionValue +
			", xuexiName=" + xuexiName +

...
public class DangkeCollectionView extends DangkeCollectionEntity implements Serializable {
	...
	*/
	...
	private String dangkeCollectionValue;
	...
	public DangkeCollectionView() {

	}

	public DangkeCollectionView(DangkeCollectionEntity dangkeCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, dangkeCollectionEntity);
	...
	* 获取： 类型的值
	*/
	public String getDangkeCollectionValue() {
		return dangkeCollectionValue;
	}
	/**
	* 设置： 类型的值
	*/
	public void setDangkeCollectionValue(String dangkeCollectionValue) {
		this.dangkeCollectionValue = dangkeCollectionValue;
	}
	...
	public String toString() {
		return "DangkeCollectionView{" +
			", dangkeCollectionValue=" + dangkeCollectionValue +

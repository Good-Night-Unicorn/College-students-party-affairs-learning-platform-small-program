	...
	<view class="content">
		<view class="box"
			...
			<view v-if="tableName=='yonghu'" class="cu-form-group select">
				...
				<picker @change="yonghushenqingYuyueTypesChange" :value="shenqingYuyueTypesIndex"
					:range="shenqingYuyueTypesOptions" range-key="indexName">
					<view
						:style='{"padding":"0 30rpx","boxShadow":"0 0 16rpx var(--publicSubColor) inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"var(--publicMainColor)","borderRadius":"20rpx","color":"var(--publicMainColor)","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
						class="uni-input picker-select-input">
						{{ruleForm.shenqingYuyueValue?ruleForm.shenqingYuyueValue:"请选择申请状态"}}</view>
				</picker>
			</view>
			<view v-if="tableName=='yonghu'" class="cu-form-group select">
				<view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
	...
	export default {
		...
		async onLoad() {
			...
			if (this.tableName == 'yonghu') {
				let shenqing_yuyue_typesParams = {
					page: 1,
					limit: 100,
					dicCode: 'shenqing_yuyue_types',
				}
				let shenqing_yuyue_typesRes = await this.$api.page(`dictionary`, shenqing_yuyue_typesParams);

				this.shenqingYuyueTypesOptions = shenqing_yuyue_typesRes.data.list
				let sex_typesParams = {
					page: 1,
					limit: 100,
					dicCode: 'sex_types',
		...
		methods: {
			// 下拉变化
			yonghushenqingYuyueTypesChange(e) {

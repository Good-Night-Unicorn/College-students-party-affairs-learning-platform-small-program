        ...
        <form class="app-update-pv">
			<view
                ...
                <textarea
                        ...
                        v-model='ruleForm.dangkeCommentbackText' placeholder="留言内容"></textarea>
            </view>
    ...
    export default {
        ...
        async onLoad(options) {
            ...
            if (options.id) {
                ...
                // 获取信息
                let res = await this.$api.info(`dangkeCommentback`, this.ruleForm.id);
        ...
        methods: {
            ...
            async onSubmitTap() {
			if ((!this.ruleForm.dangkeCommentbackText)) {
                this.$utils.msg(`留言内容不能为空`);
                return
            }
                if (this.ruleForm.id) {
                    await this.$api.update(`dangkeCommentback`, this.ruleForm);
                } else {
                    await this.$api.save(`dangkeCommentback`, this.ruleForm);
                }

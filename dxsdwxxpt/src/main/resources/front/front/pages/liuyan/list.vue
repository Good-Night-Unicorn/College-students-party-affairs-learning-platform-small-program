		...
		<view class="cu-bar bg-white search" :style="[{top:CustomBar + 'px'}]">
			<view class="search-form round">
				<input
					...
					v-model="searchForm.liuyanText" type="text" placeholder="留言内容"></input>
			</view>
			...
			<view class="action">
				...
				<view v-if="isAuth('liuyan','报表')" @tap="openChartDialog"
					:style="{padding:'0 10rpx',lineHeight:'80rpx',width:'auto',height:'80rpx',fontSize:'28rpx',color:'rgba(239, 239, 239, 1)',backgroundColor:btnColor[0],borderColor:btnColor[0]}">
					报表
				</view>
				<view
			...
			<view class="list b-b" v-for="(item, index) in list" :key="index"
				...
				<view class="wrapper" style="padding: 10rpx 3rpx;margin-left: 25upx;margin-top: 10upx;">
					...
					<view class="u-box" style="color: #8799A3;">
						<text class="name" style="margin-left: 30rpx;font-size: 23rpx;">留言：{{item.liuyanText}}</text>
					</view>
					<view class="u-box" style="color: #8799A3;"
	...
	export default {
		...
		methods: {
			...
			async search() {
				...
				if (this.searchForm.liuyanText) {
					searchForm['liuyanText'] = this.searchForm.liuyanText
				}

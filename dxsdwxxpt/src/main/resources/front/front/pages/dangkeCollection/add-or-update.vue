    ...
    <view class="content">
        <form class="app-update-pv">
                ...
                <view :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"100rpx"}'
                    ...
                    <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                          class="title">类型</view>
                    <picker @change="dangkeCollectionTypesChange" :value="dangkeCollectionTypesIndex" :range="dangkeCollectionTypesOptions" range-key="indexName">
                        <view
                                :style='{"padding":"0 30rpx","boxShadow":"0 0 16rpx var(--publicSubColor) inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"var(--publicMainColor)","borderRadius":"20rpx","color":"var(--publicMainColor)","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                                class="uni-input">{{ruleForm.dangkeCollectionTypes?ruleForm.dangkeCollectionValue:"请选择类型"}}</view>
                    </picker>
                </view>
    ...
    export default {
        data() {
            ...
            ruleForm: {
					dangkeId: '',
					yonghuId: '',
					dangkeCollectionTypes: '',//数字
					dangkeCollectionValue: '',//数字对应的值
					insertTime: '',
					createTime: '',
            },
            // 登陆用户信息
		...
		/*下拉框*/
			let dangkeCollectionTypesParams = {
                page: 1,
                limit: 100,
                dicCode: 'dangke_collection_types',
            }
			let dangkeCollectionTypes = await this.$api.page(`dictionary`, dangkeCollectionTypesParams);
			this.dangkeCollectionTypesOptions = dangkeCollectionTypes.data.list
            ...
            if (options.id) {
                ...
                // 获取信息
                let res = await this.$api.info(`dangkeCollection`, this.ruleForm.id);
                this.ruleForm = res.data;
            }
            if(options.dangkeCollectionId){
                this.ruleForm.dangkeCollectionId = options.dangkeCollectionId;
            }
            // 跨表
            // this.styleChange()
        },
        methods: {
            ...
            async onSubmitTap() {
                if (this.ruleForm.id) {
                    await this.$api.update(`dangkeCollection`, this.ruleForm);
                } else {
                    await this.$api.save(`dangkeCollection`, this.ruleForm);
                }

<template>
	...
	<view class="cu-bar bg-white search" :style="[{top:CustomBar + 'px'}]">
        ...
        <view class="action">
            ...
            <view v-if="isAuth('zuoye','报表')" @tap="openChartDialog" :style="{padding:'0 10rpx',lineHeight:'80rpx',width:'auto',height:'80rpx',fontSize:'28rpx',color:'rgba(239, 239, 239, 1)',backgroundColor:btnColor[0],borderColor:btnColor[0]}">
                报表
            </view>
                    ...
                    <view style="display: flex;">
                        <view style="display: flex;flex-direction: column;width: 100%;">
                            <view :style='zuoyeTypes===item.codeIndex?sactiveItem:sitem' class="tab"
                                  v-for="(item,index) in zuoyeTypesList" :key="index" :class="zuoyeTypes===item.codeIndex?'tabActive':''"
                                  @tap="zuoyeTypesCategoryClick(item.codeIndex)">
                                {{item.indexName}}
                            </view>
                        </view>
                    </view>
    ...
    <view class="list"
        ...
        <view @tap="onDetailTap(product)" class="listm flex flex-between"
            ...
            <image
                    ...
                    :src="product.zuoyePhoto?baseUrl+product.zuoyePhoto.split(',')[0]:''"></image>
            <view class="listmr">
                <view class="hide2"
                ...
                <view v-if="product.zuoyeNewMoney"
                    ...
                    ￥{{product.zuoyeNewMoney}}
                </view>
                <view v-else-if="product.zuoyeValue"
                      :style='{"padding":"10rpx 10rpx 0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0 auto","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(0,0,0,0)","color":"rgba(0, 0, 0, 1)","textAlign":"left","borderRadius":"0","borderWidth":"0","width":"100%","lineHeight":"40rpx","fontSize":"28rpx","borderStyle":"solid"}'>
                    {{product.zuoyeValue}}
                </view>

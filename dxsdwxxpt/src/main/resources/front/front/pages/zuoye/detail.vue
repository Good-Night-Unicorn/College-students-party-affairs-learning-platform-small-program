			...
			<view class="yinyuewai">
				<view class="yinyuenei"><!-- @tap="onErweima()" -->
						...
						<view class="shangpinfei">
							{{detail.zuoyeName}}<!-- <uni-icons type="scan" size="30"></uni-icons> -->
						</view>
				...
				<view class="xiangqing" @tap="download(baseUrl + detail.zuoyeFile)">
					<view class="shangpinxiangqing">
						<view class="box">
							作业下载：
						</view>
	...
	<script>
		export default {
			...
			methods: {
				...
				// 获取详情
				async init() {
					let res = await this.$api.detail('zuoye', this.zuoyeId);

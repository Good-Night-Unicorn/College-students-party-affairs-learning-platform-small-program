        ...
        <view class="listBox recommend">
                ...
                <view class="title"
                    ...
                    <text
                            ...
                            @tap="onPageTap('xuexi')">查看更多
                    </text>
                </view>
<view v-if='2 == 2' class="uni-product-list" :class="2 == 2 ? 'active' : ''" :style='{"borderRadius":"0","backgroundColor":"#efefef"}'>
    <view @tap="onDetailTap('xuexi',product.id)" :style='{"borderRadius":"8rpx","backgroundColor":"#fff"}' class="uni-product" v-for="(product,index) in xuexiList" :key="index">
        <view :style='{"fontSize":"28rpx","lineHeight":"56rpx","color":"var(--publicMainColor)","textAlign":"center"}' class="uni-product-title">{{product.xuexiName}}</view>
        <view class="image-view" :style='{"borderRadius":"2rpx","height":"180rpx"}'>
            <image :style='{"borderRadius":"2rpx","height":"180rpx"}' mode="aspectFill" class="uni-product-image" :src="baseUrl+product.xuexiPhoto"></image>
        </view>
    </view>
</view>
        </view>
    ...
    <view @tap="onDetailTap('gonggao',item.id)" v-for="(item,index) in gonggaoList" :key="index" class="list-item"
        ...
        <view class="listBox recommend">
                ...
                <view class="title"
                    ...
                    <text
                            :style='{"padding":"0 20rpx 0 0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"var(--publicSubColor)","color":"rgba(0, 0, 0, 1)","textAlign":"right","borderRadius":"0 20rpx 0 0","borderWidth":"0","width":"45%","lineHeight":"80rpx","fontSize":"28rpx","borderStyle":"solid"}'
                            @tap="onPageTap('zuoye')">查看更多
                    </text>
                </view>
<view v-if='2 == 2' class="uni-product-list" :class="2 == 2 ? 'active' : ''" :style='{"borderRadius":"0","backgroundColor":"#efefef"}'>
    <view @tap="onDetailTap('zuoye',product.id)" :style='{"borderRadius":"8rpx","backgroundColor":"#fff"}' class="uni-product" v-for="(product,index) in zuoyeList" :key="index">
        <view :style='{"fontSize":"28rpx","lineHeight":"56rpx","color":"var(--publicMainColor)","textAlign":"center"}' class="uni-product-title">{{product.zuoyeName}}</view>
        <view class="image-view" :style='{"borderRadius":"2rpx","height":"180rpx"}'>
            <image :style='{"borderRadius":"2rpx","height":"180rpx"}' mode="aspectFill" class="uni-product-image" :src="baseUrl+product.zuoyePhoto"></image>
        </view>
    </view>
</view>
        </view>
        <view class="listBox recommend">
                ...
                <view class="title"
                    ...
                    <text
                            :style='{"padding":"0 20rpx 0 0","boxShadow":"0 2rpx 12rpx rgba(0,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"var(--publicSubColor)","color":"rgba(0, 0, 0, 1)","textAlign":"right","borderRadius":"0 20rpx 0 0","borderWidth":"0","width":"45%","lineHeight":"80rpx","fontSize":"28rpx","borderStyle":"solid"}'
                            @tap="onPageTap('dangke')">查看更多
                    </text>
                </view>
<view v-if='2 == 2' class="uni-product-list" :class="2 == 2 ? 'active' : ''" :style='{"borderRadius":"0","backgroundColor":"#efefef"}'>
    <view @tap="onDetailTap('dangke',product.id)" :style='{"borderRadius":"8rpx","backgroundColor":"#fff"}' class="uni-product" v-for="(product,index) in dangkeList" :key="index">
        <view :style='{"fontSize":"28rpx","lineHeight":"56rpx","color":"var(--publicMainColor)","textAlign":"center"}' class="uni-product-title">{{product.dangkeName}}</view>
        <view class="image-view" :style='{"borderRadius":"2rpx","height":"180rpx"}'>
            <image :style='{"borderRadius":"2rpx","height":"180rpx"}' mode="aspectFill" class="uni-product-image" :src="baseUrl+product.dangkePhoto"></image>
        </view>
    </view>
</view>
        </view>
...
<script>
    ...
    export default {
        ...
        async onShow() {
            ...
            let xuexi = await this.$api.requestCondition('xuexi','gexingtuijian',xuexiVal);

            this.xuexiList = xuexi.data.list
            this.xuexiList.forEach(function(item, index) {
            ...
            let zuoye = await this.$api.list('zuoye', {
                page: 1,
                limit: 6,
                });

            this.zuoyeList = zuoye.data.list
            this.zuoyeList.forEach(function(item, index) {
            ...
            let dangke = await this.$api.requestCondition('dangke','gexingtuijian',dangkeVal);

            this.dangkeList = dangke.data.list
            this.dangkeList.forEach(function(item, index) {

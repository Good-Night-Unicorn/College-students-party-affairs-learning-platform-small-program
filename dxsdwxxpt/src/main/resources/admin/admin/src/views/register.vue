    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">大学生党务学习平台注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        <el-form-item label="党务工作者姓名" class="input" v-if="tableName=='gongzuo'">
                            <el-input v-model="ruleForm.gongzuoName" autocomplete="off" placeholder="党务工作者姓名"  />
                        </el-form-item>
                        <el-form-item label="党务工作者手机号" class="input" v-if="tableName=='gongzuo'">
                            <el-input v-model="ruleForm.gongzuoPhone" autocomplete="off" placeholder="党务工作者手机号"  />
                        </el-form-item>
                        <el-form-item label="党务工作者身份证号" class="input" v-if="tableName=='gongzuo'">
                            <el-input v-model="ruleForm.gongzuoIdNumber" autocomplete="off" placeholder="党务工作者身份证号"  />
                        </el-form-item>
                        <!--
                            <el-form-item v-if="gongzuoPhotoFlag">
                            </el-form-item>
                            <el-form-item label="党务工作者头像" class="input" v-if="tableName=='gongzuo'">
                                    <file-upload
                                        tip="点击上传党务工作者头像"
                                        action="file/upload"
                                        :limit="1"
                        ...
                        -->
                        <!--
                            <el-form-item label="申请状态" class="input" v-if="tableName=='gongzuo'">
                                <el-input v-model="ruleForm.shenqingYuyueTypes" autocomplete="off" placeholder="申请状态"  />
                           </el-form-item>
                        -->
                        <el-form-item label="电子邮箱" class="input" v-if="tableName=='gongzuo'">
                            <el-input v-model="ruleForm.gongzuoEmail" autocomplete="off" placeholder="电子邮箱"  />
                        </el-form-item>
                        <!--
                        ...
                        -->
                        <!--
                            <el-form-item label="申请状态" class="input" v-if="tableName=='yonghu'">
                                <el-input v-model="ruleForm.shenqingYuyueTypes" autocomplete="off" placeholder="申请状态"  />
                           </el-form-item>
                        -->
        ...
        methods: {
            ...
            login() {
                            ...
                            if((!this.ruleForm.gongzuoName)&& 'gongzuo'==this.tableName){
                                this.$message.error('党务工作者姓名不能为空');
                                return
                            }
                            ...
                            if((!this.ruleForm.gongzuoIdNumber)&& 'gongzuo'==this.tableName){
                                this.$message.error('党务工作者身份证号不能为空');
                                return
                            }
                            // gongzuo 中的 党务工作者头像 判空处理
                            // if('gongzuo' == this.tableName && (this.ruleForm.gongzuoPhoto== null ||this.ruleForm.gongzuoPhoto== "")){
                            //     this.$message.error("党务工作者头像不能为空");
                            //     return
                            // }
                            // gongzuo 中的 申请状态 判空处理
                            // if('gongzuo' == this.tableName && (this.ruleForm.shenqingYuyueTypes== null ||this.ruleForm.shenqingYuyueTypes== "")){
                            ...
                            // }
                            // yonghu 中的 申请状态 判空处理
                            // if('yonghu' == this.tableName && (this.ruleForm.shenqingYuyueTypes== null ||this.ruleForm.shenqingYuyueTypes== "")){
                            //     this.$message.error("申请状态不能为空");
                            //     return
                            // }
...
<style lang="scss" scoped>
	...
	.container {
		...
		background-image: url(/dxsdwxxpt/img/back-img-bg.jpg);

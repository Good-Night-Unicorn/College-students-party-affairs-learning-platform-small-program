<template>
    <div class="addEdit-block">
        <el-form
                ...
                >
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='gongzuo'">
                    <el-form-item class="select" v-if="type!='info'"  label="党务工作者" prop="gongzuoId">
                        <el-select v-model="ruleForm.gongzuoId" :disabled="ro.gongzuoId" filterable placeholder="请选择党务工作者" @change="gongzuoChange">
                            <el-option
                                    v-for="(item,index) in gongzuoOptions"
                                    v-bind:key="item.id"
                                    :label="item.gongzuoName"
                                    :value="item.id">
                            </el-option>
                        </el-select>
                    </el-form-item>
                ...
                <el-col :span="12"  v-if="sessionTable !='gongzuo' ">
                    <el-form-item class="input" v-if="type!='info'"  label="党务工作者姓名" prop="gongzuoName">
                        <el-input v-model="gongzuoForm.gongzuoName"
                                  placeholder="党务工作者姓名" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="党务工作者姓名" prop="gongzuoName">
                            <el-input v-model="ruleForm.gongzuoName"
                                      placeholder="党务工作者姓名" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='gongzuo' ">
                    <el-form-item class="input" v-if="type!='info'"  label="党务工作者手机号" prop="gongzuoPhone">
                        <el-input v-model="gongzuoForm.gongzuoPhone"
                                  placeholder="党务工作者手机号" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="党务工作者手机号" prop="gongzuoPhone">
                            <el-input v-model="ruleForm.gongzuoPhone"
                                      placeholder="党务工作者手机号" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='gongzuo' ">
                    <el-form-item class="input" v-if="type!='info'"  label="党务工作者身份证号" prop="gongzuoIdNumber">
                        <el-input v-model="gongzuoForm.gongzuoIdNumber"
                                  placeholder="党务工作者身份证号" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="党务工作者身份证号" prop="gongzuoIdNumber">
                            <el-input v-model="ruleForm.gongzuoIdNumber"
                                      placeholder="党务工作者身份证号" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12" v-if="sessionTable !='gongzuo' ">
                    <el-form-item class="upload" v-if="type!='info' && !ro.gongzuoPhoto" label="党务工作者头像" prop="gongzuoPhoto">
                        <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (gongzuoForm.gongzuoPhoto || '').split(',')" :src="$base.url+item" width="100" height="100">
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.gongzuoPhoto" label="党务工作者头像" prop="gongzuoPhoto">
                ...
                <el-col :span="12"  v-if="sessionTable !='gongzuo' ">
                    <el-form-item class="input" v-if="type!='info'"  label="申请状态" prop="shenqingYuyueValue">
                        <el-input v-model="gongzuoForm.shenqingYuyueValue"
                ...
                <el-col :span="12"  v-if="sessionTable !='gongzuo' ">
                    <el-form-item class="input" v-if="type!='info'"  label="电子邮箱" prop="gongzuoEmail">
                        <el-input v-model="gongzuoForm.gongzuoEmail"
                                  placeholder="电子邮箱" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="电子邮箱" prop="gongzuoEmail">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   gongzuoId: [
                              { required: true, message: '党务工作者不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }

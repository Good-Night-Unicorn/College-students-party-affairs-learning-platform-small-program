    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="档案名称" prop="danganName">
                       <el-input v-model="ruleForm.danganName"
                                 placeholder="档案名称" clearable  :readonly="ro.danganName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="档案名称" prop="danganName">
                           <el-input v-model="ruleForm.danganName"
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.danganPhoto" label="档案照片" prop="danganPhoto">
                        <file-upload
                            tip="点击上传档案照片"
                            action="file/upload"
                            :limit="3"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.danganPhoto" label="档案照片" prop="danganPhoto">
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.danganFile" label="档案文件" prop="danganFile">
                        <file-upload
                                tip="点击上传档案文件"
                                action="file/upload"
                                :limit="3"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.danganFile" label="档案文件" prop="danganFile">
                            <a type="text" style="text-decoration:none" class="el-button" :href="$base.url+ruleForm.danganFile"  >档案文件下载</a>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.danganContent"  label="档案介绍" prop="danganContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.danganContent" label="档案介绍" prop="danganContent">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   danganPhoto: [
                              { required: true, message: '档案照片不能为空', trigger: 'blur' },
                          ],
                   danganTypes: [
                   ...
                   danganFile: [
                              { required: true, message: '档案文件不能为空', trigger: 'blur' },
                          ],
                   danganContent: [
                              { required: true, message: '档案介绍不能为空', trigger: 'blur' },
                          ],
                   danganDelete: [

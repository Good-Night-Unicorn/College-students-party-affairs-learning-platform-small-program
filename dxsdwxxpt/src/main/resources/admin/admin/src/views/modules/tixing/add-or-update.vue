    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="留言内容" prop="tixingText">
                        <el-input type="textarea"  :readonly="ro.tixingText" v-model="ruleForm.tixingText" placeholder="留言内容"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.tixingText" label="留言内容" prop="tixingText">
                            <span v-html="ruleForm.tixingText"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`tixing/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.tixingCrossAddOrUpdateFlag = false;
                                        this.parent.search();
